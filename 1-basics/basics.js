...
describe("basics", function() {
  ...
  describe("A falsy string", function() {
    it("should run without errors", function() {
      ...
      if (falsyString) {
        throw new Error("if() has been executed: falsyString is not falsy.");
      }
    });
  });
  ...
  describe("Falsy numbers", function() {
    it("should run without errors", function() {
      ...
      if (falsyNumber1) {
        throw new Error("if() has been executed: falsyNumber1 is not falsy.");
      }
      if (falsyNumber2) {
        throw new Error("if() has been executed: falsyNumber2 is not falsy.");
      }
    });
  });
  ...
  describe("A falsy object?", function() {
    it("should run without errors", function() {
      ...
      if (falsyThing) {
        throw new Error("if() has been executed: falsyThing is not falsy.");
      }
    });
  });
